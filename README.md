...
## 👉 Если ты Валентина и не знаешь с чего начать

**Открой [`MASTER-PLAN.md`](./MASTER-PLAN.md)** — там подробный план каждого действия по порядку: от создания учётки на VPS до сдачи заказчику. Все «куда нажать», «что вписать», «как проверить» — там.
