...
const CATEGORY_LANDINGS = {
  ...
  // в «Основные технические характеристики» (bulletsTitle) с рядами Масса/Тяга/Мощность/Скорость.
  rantsy: {
    ...
    bulletsTitle: 'Основные технические характеристики',
    description: [
...
function initProductDetail() {
  ...
  if (bulletsBlock && bulletsList) {
    if (kind === 'landing' && Array.isArray(data.bullets)) {
      ...
      // переопределяют на «Основные технические характеристики» (правка заказчика).
