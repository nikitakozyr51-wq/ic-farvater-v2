...
const SERIES_SPECS = {
  ...
  kama: [['вход', '230 В (176–242 В)'], ['мощность', '50–1000 Вт'], ['выходы', '5–48 В (6 номиналов)'], ['температура', '−60…+100 °C (исп. Р/С)'], ['корпуса', 'F5–F8']],
  ...
  'et-2rmt': [['контакты', '4–50'], ['напряжение', 'до 560 В'], ['ток', '5/10/20/40 А'], ['температура', '−60…+150 °C'], ['вибрация', '1–5000 Гц'], ['удар', '5000 м/с² одиночный'], ['корпуса', 'размеры 14–45'], ['ресурс', '500 циклов, наработка 1000 ч'], ['покрытия', 'золото, серебро']],
  'et-2rtt': [['напряжение', 'до 850 В'], ['теплостойкость', '100 °C'], ['сочленение', 'резьбовое, одна шпонка'], ['исполнение', 'приборное и кабельное'], ['корпус', 'прямой или угловой'], ['ресурс', '500 циклов, наработка 1000 ч'], ['покрытия', 'серебро']],
  'et-2rmp': [['статус', 'в разработке'], ['ту', 'на стадии утверждения'], ['корпуса', 'размеры 14–30 (предварительно)'], ['контакты', '4–32 (предварительно)'], ['исполнение', 'приборное, внутренний монтаж']],
  ...
  'et-snc144': [['совместимость', 'MIL-DTL-38999 Series III'], ['экранирование', '65–85 дБ'], ['напряжение', 'до 500 В'], ['теплостойкость', 'до +200 °C'], ['ресурс', '500 циклов'], ['сохраняемость', '15 лет'], ['покрытия', 'золото · никель/кадмий'], ['ту', 'ТКЕС.434410.049 ТУ']],
  'et-snc28': [['сочленение', 'байонетное'], ['корпус', 'металлический, экранированный'], ['защита', 'от ЭМП и климатики'], ['цепи', 'силовые и сигнальные'], ['ту', 'ТКЕС.434410.012 ТУ']],
  ...
  'et-shr': [['цепи', 'постоянный и переменный ток'], ['сочленение', 'байонетное'], ['корпус', 'металлический'], ['стойкость', 'климатическая и механическая'], ['совместимость', 'замена серии ШР'], ['ту', 'ТКЕС.434410.003 ТУ']],
  'et-onc-bs': [['цепи', 'постоянный / переменный / импульсный'], ['частота', 'до 3 МГц'], ['сочленение', 'байонетное, быстросъёмное'], ['фиксация', 'надёжная при вибрации'], ['назначение', 'силовые и сигнальные цепи'], ['совместимость', 'аналог ОНЦ-БС-1(2)'], ['ту', 'ТКЕС.434410.024 ТУ']],
  'et-onc-bm': [['контакты', 'Ø1,0 мм, до 102 в корпусе'], ['напряжение', '150 В'], ['температура', '−60…+85 °C'], ['вибрация', '1–5000 Гц'], ['удар', '10 000 / 1500 м/с²'], ['ресурс', '250 циклов, наработка 5000 ч'], ['покрытия', 'серебро, золото'], ['ту', 'ТКЕС.434410.047 ТУ']],
  'et-mr1': [['цепи', 'сигнальные и низковольтные'], ['сочленение', 'байонетное, без инструмента'], ['конструктив', 'малогабаритный цилиндрический'], ['исполнения', 'вилки и розетки, с кожухом'], ['покрытия', 'серебро, золото'], ['ту', 'ТКЕС.434410.032 ТУ']],
  'et-rrs': [['частота', 'до 3 МГц'], ['напряжение', 'до 200 В'], ['исполнение', 'герметичное, всеклиматическое'], ['стойкость', 'вибро- и ударопрочное'], ['поляризация', 'многопозиционная'], ['ту', 'ТКЕС.434410.045 ТУ']],
  'et-rsg': [['назначение', 'ВЧ- и СВЧ-цепи'], ['исполнения', 'ЕТ-РС / ЕТ-РСГ (герметичное)'], ['потери на передачу', 'низкие'], ['волновое сопротивление', 'стабильное'], ['ту', 'ТКЕС.434410.026 ТУ']],
  'et-ek-ep': [['назначение', 'защита контактной пары'], ['исполнения', 'ЕТ-ЭК (розетки) / ЕТ-ЭП (вилки)'], ['типы', 'заглушки для СНЦ23, 2РМ, ОНЦ'], ['совместимость', 'серии ЕТ-2РМ, ЕТ-2РТТ, ЕТ-СНЦ'], ['режим', 'хранение и транспортировка'], ['ту', 'ТКЕС.434410.014 / .016 / .024']],
  'et-rbm4': [['статус', 'перспективная серия, в разработке'], ['тип', 'блочные малогабаритные'], ['назначение', 'межмодульная коммутация'], ['ту', 'не утверждены']],
  'et-rbn2': [['тип', 'блочные низкочастотные'], ['контакты', '18–34 (предварительно)'], ['конструктив', 'вилки и розетки'], ['статус', 'серия в разработке'], ['ту', 'не утверждены']],
  'et-rvn1': [['тип', 'врубные низкочастотные'], ['сочленение', 'автоматическое при стыковке'], ['статус', 'серия в разработке'], ['ту', 'не утверждены']],
  'et-rvn2': [['тип', 'врубные соединители'], ['сочленение', 'автоматическое при стыковке'], ['монтаж', 'сборка без инструмента'], ['ресурс', 'многократные циклы'], ['конструктив', 'вилки и розетки'], ['ту', 'ТКЕС.434410.020 ТУ']],
  'et-snc13': [['тип', 'цилиндрические СНЦ13'], ['конструктив', 'вилки и розетки'], ['типоразмеры', '10/10, 19/12, 30/14'], ['статус', 'частично в разработке'], ['ту', 'ТКЕС.434410.036 ТУ']],
  'et-snc146': [['статус', 'перспективная серия, в разработке'], ['конструкция', 'цилиндрический соединитель'], ['назначение', 'коммутация цепей'], ['ту', 'не утверждены']],
  'et-snc147': [['статус', 'перспективная серия, в разработке'], ['конструкция', 'цилиндрический соединитель'], ['контакты', '3–22 (предварительный ряд)'], ['исполнения', 'вилки и розетки'], ['номенклатура', '16 позиций (предварительно)'], ['ту', 'не утверждены']],
  'et-snc233': [['статус', 'перспективная серия, в разработке'], ['конструкция', 'цилиндрический соединитель'], ['сочленение', 'байонетное'], ['корпус', 'с экранированием'], ['назначение', 'коммутация цепей в РЭА'], ['ту', 'не утверждены']]
};
...
function variantSpecs(kindKey, series, item) {
  ...
  if (kindKey === 'capacitor') {
    ...
    // «150 В Код 151 или 300 В Код 301» → «150 В (код 151) или 300 В (код 301)»
...
const CATEGORY_LANDINGS = {
  ...
  capacitors: {
    ...
    description: [
      ...
      'Корпуса 0505, 2225 и&nbsp;3838, ёмкость 0,1–5100&nbsp;пФ, рабочее напряжение от&nbsp;150 до&nbsp;7200&nbsp;В в&nbsp;зависимости от&nbsp;серии, температура −55…+200&nbsp;°С. Применяются в&nbsp;усилителях мощности, задающих генераторах, согласующих цепях и&nbsp;СВЧ-фильтрах.'
    ],
    bullets: [
    ...
    nomenclature: [
      ...
      ['ёмкость',     '0,1–5100&nbsp;пф'],
      ['корпуса',     '0505 (a)&nbsp;· 2225 (c)&nbsp;· 3838 (e)'],
      ['напряжение',  '150/300&nbsp;в (a)&nbsp;· 2500/3600&nbsp;в (c)&nbsp;· 3600/7200&nbsp;в (e)'],
