...
const PRODUCTS = [
  ...
  },
  {
    ...
    "category": "",
    "subcategory": "",
    "description": "Реактивный ранец: Революция в персональной мобильности и специальных операциях!\nРеактивный ранец – инновационное устройство, открывающее новые горизонты в самых разнообразных сферах. От спасения жизней в экстремальных условиях до выполнения секретных миссий и предоставления уникальных развлекательных возможностей – реактивный ранец меняет представление о возможном.\nОсновные области применения:\n•\tАварийно-спасательные операции: Оперативное реагирование при пожарах в высотных зданиях, горно-спасательные работы, экстренное прибытие на места стихийных бедствий.\n•\tПромышленные операции: Инспекция и техническое обслуживание объектов энергетики, ветровой энергетики, нефтегазовой отрасли, а также высотного и инфраструктурного оборудования.\n•\tКультурный туризм и развлечения: Захватывающие полеты над живописными ландшафтами, эффектные шоу в тематических парках, экстремальные виды спорта и впечатляющие спецэффекты для кино и телевидения.\n•\tЛичные поездки: Перспективное решение для коротких перемещений на малых высотах, позволяющее избежать транспортных пробок (требует дальнейшего развития технологии).\n![ранец1.png](https://cms.ic-farvater.ru/uploads/ranecz1_69f971bd3d.png)\n",
    "image": "",
    "specs": {}
  },
  {
    ...
    "category": "",
    "subcategory": "",
    "description": "Реактивный ранец: революция в сфере индивидуальной мобильности и специальных операций!\nРеактивный ранец — инновационное устройство, открывающее новые горизонты в самых разных областях. От спасения жизней в экстремальных условиях до выполнения секретных миссий и уникальных развлекательных возможностей — реактивный ранец меняет представление о возможном.\nОсновные области применения:\n• Аварийно-спасательные операции: оперативное реагирование при пожарах в высотных зданиях, горно-спасательные работы, экстренное прибытие на места стихийных бедствий.\n• Производственные операции: инспекция и техническое обслуживание объектов энергетики, ветряной энергетики, нефтегазовой отрасли, а также высотного и инфраструктурного оборудования.\n• Культурный туризм и развлечения: захватывающие полеты над живописными ландшафтами, эффектные шоу в тематических парках, экстремальные виды спорта и впечатляющие спецэффекты для кино и телевидения.\n• Личные поездки: перспективное решение для коротких поездок на небольшие расстояния, позволяющее избежать пробок (требует дальнейшего развития технологии).\n![ранец1.png](https://cms.ic-farvater.ru/uploads/ranecz1_69f971bd3d.png)",
    "image": "",
    "specs": {}
  },
  {
  ...
  },
  {
    ...
    "name": "Реактивный ранец",
    "category": "",
    "subcategory": "Реактивный ранец",
    "description": "Реактивный ранец: Революция в персональной мобильности и специальных операциях!\nРеактивный ранец – инновационное устройство, открывающее новые горизонты в самых разнообразных сферах. От спасения жизней в экстремальных условиях до выполнения секретных миссий и предоставления уникальных развлекательных возможностей – реактивный ранец меняет представление о возможном.\nОсновные области применения:\n•\tАварийно-спасательные операции: Оперативное реагирование при пожарах в высотных зданиях, горно-спасательные работы, экстренное прибытие на места стихийных бедствий.\n•\tПромышленные операции: Инспекция и техническое обслуживание объектов энергетики, ветровой энергетики, нефтегазовой отрасли, а также высотного и инфраструктурного оборудования.\n•\tКультурный туризм и развлечения: Захватывающие полеты над живописными ландшафтами, эффектные шоу в тематических парках, экстремальные виды спорта и впечатляющие спецэффекты для кино и телевидения.\n•\tЛичные поездки: Перспективное решение для коротких перемещений на малых высотах, позволяющее избежать транспортных пробок (требует дальнейшего развития технологии).\n![ранец1.png](https://cms.ic-farvater.ru/uploads/ranecz1_dc98ba32fe.png)",
    "image": "![ранец1.png](https://cms.ic-farvater.ru/uploads/ranecz1_dc98ba32fe.png)",
    "specs": {}
  },
  {
    "id": 99,
    "name": "Реактивный ранец",
    "category": "Реактивный ранец",
    "subcategory": "Реактивный ранец",
    ...
    "image": "![ранец1.png](https://cms.ic-farvater.ru/uploads/ranecz1_a32735f094.png)",
    "specs": {
      "Реактивный ранец:": "Революция"
    }
  },
  {
    "id": 100,
